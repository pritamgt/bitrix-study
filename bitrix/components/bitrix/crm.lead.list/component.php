...
{
	$config = \Bitrix\Crm\Conversion\LeadConversionManager::create(array())->getConfig();
...
$arResult['HEADERS'] = array_merge(
	...
	array(
		...
		array(
			...
			'editable' => array(
				'items' => array_merge(
					array('0' => GetMessage('CRM_HONORIFIC_NOT_SELECTED')),
...
{
	$waitingInfos = \Bitrix\Crm\Pseudoactivity\WaitEntry::getRecentInfos(CCrmOwnerType::Lead, $aclivitylessItems);
...
if ($sExportType == '')
{
	$schemeID = \Bitrix\Crm\Conversion\LeadConversionManager::create(array())->getCurrentSchemeID();
