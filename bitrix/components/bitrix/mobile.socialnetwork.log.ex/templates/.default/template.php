...
if (CModule::IncludeModule("vote") && class_exists("\\Bitrix\\Vote\\UF\\Manager"))
{
	...
	$APPLICATION->AddHeadString('<link href="'.CUtil::GetAdditionalFileURL('/bitrix/components/bitrix/voting.uf/templates/.default/style.css').'" type="text/css" rel="stylesheet" />');
}
else if (IsModuleInstalled("vote"))
{
	$APPLICATION->AddHeadString('<link href="'.CUtil::GetAdditionalFileURL(SITE_TEMPLATE_PATH.'/components/bitrix/voting.current/.userfield/style.css').'" type="text/css" rel="stylesheet" />');
}
