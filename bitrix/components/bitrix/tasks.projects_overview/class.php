...
//					dd($filterData);
	...
	private function getProjectTypes()
	{
		...
		if (
			empty($types) &&
			class_exists('\Bitrix\Socialnetwork\Item\Workgroup') &&
			method_exists('\Bitrix\Socialnetwork\Item\Workgroup', 'getTypes')
		)
		{
	...
	private function getCounters(array $groupIds)
	{
		...
		$groupsData = \Bitrix\Tasks\Integration\SocialNetwork\Group::getData($groupIds);
