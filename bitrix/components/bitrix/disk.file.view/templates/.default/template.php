						...
						<tr>
							...
							<td class="bx-disk-filepage-fileinfoblock">
								...
								<?php } ?>
									...
									<? if(!empty($arResult['CAN_UPDATE']) && (!$arResult['FILE']['LOCK']['IS_LOCKED'] || $arResult['FILE']['LOCK']['IS_LOCKED_BY_SELF']) && \Bitrix\Disk\Document\DocumentHandler::isEditable(GetFileExtension($arResult['FILE']['NAME'])))
									{
