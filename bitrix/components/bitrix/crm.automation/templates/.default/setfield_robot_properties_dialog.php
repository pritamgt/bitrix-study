...
<div class="crm-automation-popup-settings crm-automation-popup-settings-text">
	<a class="crm-automation-popup-settings-link" data-role="crm-sfa-fields-list">
		<?=GetMessage('CRM_AUTOMATION_SFA_FIELDS_LIST')?>
	</a>
</div>
<?= $javascriptFunctions ?>
<script>
...
<?
		...
		{
			$documentFieldValue = \Bitrix\Crm\Automation\Helper::prepareUserSelectorEntities(
