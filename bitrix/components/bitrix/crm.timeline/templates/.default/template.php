...
Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/components/bitrix/player/js/fileman_player.js');
Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/components/bitrix/player/videojs/video.js');
Bitrix\Main\Page\Asset::getInstance()->addCss('/bitrix/components/bitrix/player/videojs/video-js.css');

//HACK: Preloading files for comment editor.
Bitrix\Main\Page\Asset::getInstance()->addJs('/bitrix/components/bitrix/main.post.form/templates/.default/script.js');
Bitrix\Main\Page\Asset::getInstance()->addCss('/bitrix/components/bitrix/main.post.form/templates/.default/style.css');
...
{
	Bitrix\Main\Page\Asset::getInstance()->addCss('/bitrix/components/bitrix/socialnetwork.blog.blog/templates/.default/style.css');
}
...
{
	if (\Bitrix\Main\Loader::includeModule('fileman') && !CJSCore::IsExtRegistered('html_editor'))
	{
		$baseHtmlEditorPath = '/bitrix/js/fileman/html_editor/';
		...
		function()
		{
			...
			BX.CrmTimelineManager.create(
				"<?=CUtil::JSEscape($guid)?>",
				{
					...
					playerUrl:"/bitrix/components/bitrix/crm.timeline/player.ajax.php?&site=<?=SITE_ID?>&<?=bitrix_sessid_get()?>",
					commentEditorUrl:"/bitrix/components/bitrix/crm.timeline/editor.php?&site=<?=SITE_ID?>&<?=bitrix_sessid_get()?>",
