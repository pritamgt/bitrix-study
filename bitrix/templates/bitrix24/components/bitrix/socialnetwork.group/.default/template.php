						...
						<td class="socialnetwork-group-description"><?
							...
							if ($arResult["bUserCanRequestGroup"])
							{
								...
								?><div id="bx-group-join-form" class="sonet-group-user-request-form"><?
									?><div id="bx-group-join-error" class="sonet-ui-form-error-block"></div><?
									...
									?><span class="sonet-ui-btn-cont"><?
										...
										?><button class="ui-btn ui-btn-light-border" href="<?=$arResult["Urls"]["GroupsList"]?>"><?=Loc::getMessage("SONET_C6_ACT_RETURN_TO_LIST")?></button><?
									?></span>
