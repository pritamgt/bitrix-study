...
?><div class="feed-workday-table"><?
	?><span class="feed-workday-left-side"><?
		...
		?><span class="feed-workday-avatar"
			...
			><?
		?></span><?
		?><span class="feed-user-name-wrap"><a href="<?=$arParams['USER']["URL"]?>" class="feed-workday-user-name"><?=$arParams['USER']["NAME"]?></a><?
	...
	?><span class="feed-workday-right-side"><?
		...
		?><span class="feed-workday-avatar"
			...
			><?
		?></span><?
		?><span class="feed-user-name-wrap"><a href="<?=$arParams['MANAGER']["URL"]?>" class="feed-workday-user-name"><?=$arParams['MANAGER']["NAME"]?></a><?
