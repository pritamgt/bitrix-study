...
(
	...
	PRIMARY KEY (ID),
	UNIQUE ux_b_rest_event_app_event (APP_ID, EVENT_NAME(100), EVENT_HANDLER(200), USER_ID, CONNECTOR_ID(100)),
...
(
	...
	INDEX ix_b_rest_placement3 (PLACEMENT(100), ADDITIONAL)
);
...
(
	...
	PRIMARY KEY (ID),
	UNIQUE INDEX ux_b_rest_event_offline1 (MESSAGE_ID, APP_ID, CONNECTOR_ID, PROCESS_ID(50)),
