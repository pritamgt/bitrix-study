...
BitrixMSL.prototype.onLogEntryCommentView = function(logId, contentId) // for the feed
{
...
BitrixMSL.prototype.formatTaskDescription = function(taskDescription, livefeedUrl, entityType)
{
...
BitrixMSL.prototype.onSetLFCounter = function(ob)
{
	if (
