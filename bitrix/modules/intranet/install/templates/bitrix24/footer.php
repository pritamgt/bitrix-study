					...
					<td class="bx-layout-inner-center">
						<div id="footer">
							<span id="copyright">
								...
								<?elseif ($isBitrix24Cloud && $licensePrefix == "ru"):?>
									<a class="b24-web-form-popup-btn-57 footer-discuss-link" onclick="B24.showPartnerOrderForm();"><?=GetMessage("BITRIX24_ORDER_PARTNER")?></a>
								<?else:?>
								...
								<? if(ThemePicker::isAvailable()): ?>
									...
									><?=GetMessage("BITRIX24_THEMES")?></span>
								<? endif ?>
							</span>
						</div>
					</td>
