...
Class intranet extends CModule
{
	...
	function InstallDB()
	{
		...
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementAdd', 'intranet', '\Bitrix\Intranet\UserAbsence', 'onAfterIblockElementModify');
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementUpdate', 'intranet', '\Bitrix\Intranet\UserAbsence', 'onAfterIblockElementModify');
		$eventManager->registerEventHandlerCompatible('iblock', 'OnAfterIBlockElementDelete', 'intranet', '\Bitrix\Intranet\UserAbsence', 'onAfterIblockElementModify');
