...
elseif (preg_match("~^/company/personal/mail/manage/~i", $_SERVER["REQUEST_URI"]))
{
	include($_SERVER["DOCUMENT_ROOT"]."/settings/configs/.left.menu_ext.php");
	$APPLICATION->SetPageProperty("topMenuSectionDir", "/settings/configs/");
}