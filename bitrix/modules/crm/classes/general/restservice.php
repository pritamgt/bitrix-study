...
class CCrmRequisiteRestProxy extends CCrmRestProxyBase
{
	...
	public static function processEvent(array $arParams, array $arHandler)
	{
		...
		return parent::processEntityEvent(CCrmOwnerType::Requisite, array(array("ID" => $id)), $arHandler);
	}
}
...
class CCrmMeasureRestProxy extends CCrmRestProxyBase
{
	...
	public static function registerEventBindings(array &$bindings)
	{
		...
		$bindings[CRestUtil::EVENTS]['onCrmMeasureAdd'] = self::createEventInfo('catalog', 'MeasureOnAfterAdd', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmMeasureUpdate'] = self::createEventInfo('catalog', 'MeasureOnAfterUpdate', $callback);
		$bindings[CRestUtil::EVENTS]['onCrmMeasureDelete'] = self::createEventInfo('catalog', 'MeasureOnAfterDelete', $callback);
	}
	public static function processEvent(array $arParams, array $arHandler)
	{
		$eventName = $arHandler['EVENT_NAME'];
