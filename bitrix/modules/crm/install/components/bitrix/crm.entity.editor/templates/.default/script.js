...
if(typeof BX.Crm.EntityEditor === "undefined")
{
	...
	BX.Crm.EntityEditor.prototype =
	{
		...
		{
			if(!this._isNew && !this.hasChangedControls() && !this.hasChangedControllers())
			{
				return;
			}
...
if(typeof BX.Crm.EntityEditorControl === "undefined")
{
	...
	BX.Crm.EntityEditorControl.prototype =
	{
		...
		isContextMenuEnabled: function()
		{
			...
			return this._parent && this._parent.isContextMenuEnabled();
		},
		getMode: function()
		{
			return this._mode;
		...
		registerLayout:  function(options)
		{
			...
			{
				BX.removeClass(this._wrapper, "crm-entity-widget-content-block-field-small");
			}
...
if(typeof BX.Crm.EntityEditorField === "undefined")
{
	...
	{
		this._wrapper.style.display = (this.isVisible() && this.isNeedToDisplay()) ? "" : "none";
	...
	BX.Crm.EntityEditorField.prototype.initializeSwitchingAbilities = function()
	{
		...
		else if(this.isInSingleEditMode())
		{
	...
	BX.Crm.EntityEditorField.prototype.switchToSingleEditMode = function()
	{
		this._singleEditTimeoutHandle = 0;
	...
	BX.Crm.EntityEditorSection.prototype.createUserFieldConfigurator = function(params)
	{
		...
		this._userFieldConfigurator = BX.Crm.EntityEditorUserFieldConfigurator.create(
			"",
			{
				...
				typeId: typeId,
				field: field,
				showAlways: this._editor.getOption("show_always", "Y") === "Y"
			}
		);
...
if(typeof BX.Crm.EntityEditorAddress === "undefined")
{
	...
	BX.Crm.EntityEditorAddress.prototype.layout = function(options)
	{
		...
		if(this._mode === BX.Crm.EntityEditorMode.edit)
		{
			this._innerWrapper = BX.create("div", { attrs: { className: "crm-entity-widget-content-block-inner crm-entity-widget-content-block-inner-address" } });
			for(var key in fields)
			{
				...
				this.layoutField(key, field, label, this._innerWrapper);
			}
...
if(typeof BX.Crm.EntityEditorMultifield === "undefined")
{
	...
	BX.Crm.EntityEditorMultifield.prototype.layout = function(options)
	{
		...
		{
			BX.addClass(this._itemWrapper, "crm-entity-widget-content-block-inner");
		...
		optionWrapper.appendChild(
			BX.create(
				"a",
				{
					props:
						{
							className: "crm-entity-new-field-helper-icon",
							href: "https://helpdesk.bitrix24.ru/open/7046149/",
							target: "_blank"
						}
				}
			)
...
if(typeof BX.Crm.EntityEditorUserField === "undefined")
{
	...
	BX.Crm.EntityEditorUserField.prototype.onLayoutSuccess = function()
	{
		...
		if(this.getFieldType() === BX.Crm.EntityUserFieldType.employee)
		{
