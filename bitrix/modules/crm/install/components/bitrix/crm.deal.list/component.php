...
if (!$bInternal)
{
	...
	$arResult['FILTER'][] = Bitrix\Crm\PhaseSemantics::getListFilterInfo(CCrmOwnerType::Deal, array('id' => 'STAGE_SEMANTIC_ID', 'name' => GetMessage('CRM_COLUMN_STAGE_SEMANTIC_ID'), 'default' => true, 'params' => array('multiple' => 'Y')));
...
{
	$waitingInfos = \Bitrix\Crm\Pseudoactivity\WaitEntry::getRecentInfos(CCrmOwnerType::Deal, $aclivitylessItems);
