...
<div class="feed-task-info-block">
	...
	<div class="feed-task-info-text">
		...
		?><div class="feed-task-info-text-item">
			<span class="feed-task-info-text-title"><?=GetMessage("TASKS_SONET_LOG_RESPONSIBLE_ID")?>:</span><span class="feed-task-info-text-cont"><a id="<?php echo $anchorId; ?>" href="<?=$arResult["PATH_TO_USER"];?>"><?=CUser::FormatName($arParams["NAME_TEMPLATE"], $arResult["USER"], true);?></a></span>
		</div><?
