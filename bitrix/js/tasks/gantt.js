	...
	if (this.dateStarted != null)
   	{
		...
		{
			var left = this.chart.timeline.getPixelsFromDate(this.dateStarted);

			var dateRealBarEnd = this.dateCompleted != null ? this.dateCompleted : this.chart.currentDatetime;
			var width = dateRealBarEnd > this.dateStarted ? this.chart.timeline.getPixelsFromDate(dateRealBarEnd) - left : 0;
...
GanttTask.prototype.updateCompleteFlag = function()
{
	...
	if (this.dateCompleted != null)
	{
		...
		{
			this.layout.completeFlag.style.left = this.chart.timeline.getPixelsFromDate(this.dateCompleted) - 8 + "px";
		}
	}
	else
	{
...
GanttTask.prototype.updateDeadlineBars = function()
{
	...
	if (this.dateDeadline != null)
	{
		...
		else
		{
			...
			this.layout.deadlineSlider.style.left = this.chart.timeline.getPixelsFromDate(this.dateDeadline) + "px";
...
GanttTask.prototype.resizePlanBar = function(dateStart, dateEnd)
{
	...
	var left = this.chart.timeline.getPixelsFromDate(dateStart);
	var right = this.chart.timeline.getPixelsFromDate(dateEnd);
...
GanttTask.prototype.resizeDeadlineBar = function(dateDeadline)
{
	...
	{
		left = this.chart.timeline.getPixelsFromDate(this.dateEnd);
		right = this.chart.timeline.getPixelsFromDate(dateDeadline);
	}
	else if (dateDeadline < this.dateStart)
	{
		left = this.chart.timeline.getPixelsFromDate(this.dateDeadline);
		right = this.chart.timeline.getPixelsFromDate(this.dateStart);
	}
...
GanttTask.prototype.resizeDeadlineOverdueBar = function(dateDeadline)
{
	...
	{
		left = this.chart.timeline.getPixelsFromDate(dateDeadline);
		right = this.chart.timeline.getPixelsFromDate(this.chart.currentDatetime);
	}
	else if (this.dateCompleted != null && this.dateCompleted > dateDeadline)
	{
		left = this.chart.timeline.getPixelsFromDate(dateDeadline);
		right = this.chart.timeline.getPixelsFromDate(this.dateCompleted);
	}
...
GanttTask.prototype.onDeadlineMouseDown = function(event)
{
	...
	this.resizerOffsetX = this.chart.timeline.getPixelsFromDate(this.dateDeadline);
...
GanttTask.prototype.resizeDeadlineDate = function(offset)
{
	...
	this.dateDeadline = this.chart.timeline.getDateFromPixels(this.resizerOffsetX);
...
GanttTask.prototype.onStartDateMouseDown = function(event)
{
	...
	this.resizerOffsetX = this.chart.timeline.getPixelsFromDate(this.dateStart);
	this.resizerPageX = event.pageX;
	this.resizerChangePos = false;
...
{
	this.resizerOffsetX = this.resizerOffsetX + offset;
	var dateEndOffset = this.chart.timeline.getPixelsFromDate(this.dateEnd);
	if ( (dateEndOffset - this.resizerOffsetX) < this.chart.minBarWidth)
	{
		this.dateStart = this.chart.timeline.getDateFromPixels(dateEndOffset - this.chart.minBarWidth);
		this.isRealDateStart = true;
		this.resizePlanBar(this.dateStart, this.dateEnd);
		this.resizeDeadlineBar(this.dateDeadline);
		this.chart.tooltip.show(this.resizerOffsetX, this);
	...
	{
		this.dateStart = this.chart.timeline.getDateFromPixels(this.resizerOffsetX);
		this.isRealDateStart = true;
		this.resizePlanBar(this.dateStart, this.dateEnd);
		this.resizeDeadlineBar(this.dateDeadline);
		this.chart.tooltip.show(this.resizerOffsetX, this);
...
GanttTask.prototype.onEndDateMouseDown = function(event)
{
	...
	this.resizerOffsetX = this.chart.timeline.getPixelsFromDate(this.dateEnd);
	this.resizerPageX = event.pageX;
	this.resizerChangePos = false;
...
{
	this.resizerOffsetX = this.resizerOffsetX + offset;
	var dateStartOffset = this.chart.timeline.getPixelsFromDate(this.dateStart);
	if ((this.resizerOffsetX - dateStartOffset) < this.chart.minBarWidth)
	{
		//Min Task Width
		this.dateEnd = this.chart.timeline.getDateFromPixels(dateStartOffset + this.chart.minBarWidth);
		this.resizePlanBar(this.dateStart, this.dateEnd);
		this.resizeDeadlineBar(this.dateDeadline);
		this.chart.tooltip.show(this.resizerOffsetX, this);
	}
	...
	{
		this.dateEnd = this.chart.timeline.getDateFromPixels(this.resizerOffsetX);
		this.resizePlanBar(this.dateStart, this.dateEnd);
		this.resizeDeadlineBar(this.dateDeadline);
		this.chart.tooltip.show(this.resizerOffsetX, this);
...
GanttTask.prototype.resizeStartEndDate = function(offset)
{
	...
	this.dateStart = this.chart.timeline.getDateFromPixels(edges.startX + offset);
	this.dateEnd = this.chart.timeline.getDateFromPixels(edges.endX + offset);
...
{
	this.chart.layout.timeline.scrollLeft = this.chart.layout.timeline.scrollLeft + this.chart.chartContainer.padding;
...
Timeline.prototype.draw = function()
{
	...
	this.chart.layout.scalePrimary.innerHTML = this.createTopHeader();
	this.chart.layout.scaleSecondary.innerHTML = this.createBottomHeader();
};

Timeline.prototype.setTimelineWidth = function()
{
	var duration = BX.Tasks.Date.getDurationInUnit(this.startDate, this.endDate, this.snapUnit);
	var unitSize = this.getUnitInPixels(this.snapUnit);

	this.chart.layout.timelineInner.style.width = duration * unitSize + "px";
};
...
Timeline.prototype.expandTimelineLeft = function(date)
{
	...
	this.startDate = date;
	if (this.chart.layout.root === null)
	{
		return;
	}
	...
	var scrollLeft = this.chart.layout.timeline.scrollLeft;
	this.setTimelineWidth();
	...
	this.chart.layout.timeline.scrollLeft = scrollLeft + offset;
	this.chart.layout.scalePrimary.innerHTML = this.createTopHeader(this.startDate, oldDate) + this.chart.layout.scalePrimary.innerHTML;
	this.chart.layout.scaleSecondary.innerHTML = this.createBottomHeader(this.startDate, oldDate) + this.chart.layout.scaleSecondary.innerHTML;
};
...
Timeline.prototype.expandTimelineRight = function(date)
{
	...
	var scrollLeft = this.chart.layout.timeline.scrollLeft;
	this.setTimelineWidth();
	this.chart.layout.scalePrimary.innerHTML += this.createTopHeader(oldDate, this.endDate);
	this.chart.layout.scaleSecondary.innerHTML += this.createBottomHeader(oldDate, this.endDate);
	this.chart.layout.timeline.scrollLeft = scrollLeft;
};
...
Timeline.prototype.createTopHeader = function(start, end)
{
	return this.createHeader(start, end, "top", this.topUnit, this.topIncrement);
};

Timeline.prototype.createBottomHeader = function(start, end)
{
	return this.createHeader(start, end, "bottom", this.bottomUnit, this.bottomIncrement);
};

Timeline.prototype.createHeader = function(start, end, position, unit, increment)
{
	var startDate = start || this.getStart();
	var endDate = end || this.getEnd();
	var result = "";
...
Timeline.prototype.scrollToDate = function(date)
{
	...
	var offsetWidth = this.chart.chartContainer.width - this.chart.gutterOffset;
	var maxScrollLeft = scrollWidth - offsetWidth;

	var dateOffset = this.getPixelsFromDate(date);
	this.chart.layout.timeline.scrollLeft = dateOffset > maxScrollLeft ? maxScrollLeft : dateOffset;
};

Timeline.prototype.autoScroll = function()
{
	var viewport = this.chart.chartContainer.width - this.chart.gutterOffset;
...
Timeline.prototype.getRelativeXY = function(event)
{
	...
	return {
		x: event.pageX - this.chart.chartContainer.pos.left - this.chart.gutterOffset + this.chart.layout.timeline.scrollLeft,
...
DependencyPointer.prototype.resizePointer = function(offsetX, offsetY)
{
	...
	var point = this.chart.timeline.getRelativeXY(this.fromTask.autoResizeEvent);
...
DependencyPointer.prototype.markDroppableTask = function()
{
	...
	if (droppableBar)
	{
		...
		else if (BX.hasClass(droppablePoint, "task-gantt-point-start"))
		{
			BX.addClass(this.droppable, "task-gantt-pointer-start");
			this.toTask = droppableTask;
			this.toStart = true;
		}
		else if (BX.hasClass(droppablePoint, "task-gantt-point-end"))
		{
