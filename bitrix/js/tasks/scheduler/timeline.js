...
BX.Scheduler.Timeline = (function() {
	...
	Timeline.prototype.drawScale = function()
	{
		...
		this.layout.scalePrimary.innerHTML = this.createTopHeader();
		this.layout.scaleSecondary.innerHTML = this.createBottomHeader();
	};
	...
	Timeline.prototype.setTimelineWidth = function()
	{
		...
		this.layout.timelineInner.style.width = duration * unitSize + "px";
	};
	...
	Timeline.prototype.expandTimelineLeft = function(date)
	{
		...
		this.layout.scalePrimary.innerHTML = this.createTopHeader(this.startDate, oldDate) + this.layout.scalePrimary.innerHTML;
		this.layout.scaleSecondary.innerHTML = this.createBottomHeader(this.startDate, oldDate) + this.layout.scaleSecondary.innerHTML;
	};
	...
	Timeline.prototype.expandTimelineRight = function(date)
	{
		...
		this.layout.scalePrimary.innerHTML += this.createTopHeader(oldDate, this.endDate);
		this.layout.scaleSecondary.innerHTML += this.createBottomHeader(oldDate, this.endDate);
	...
	Timeline.prototype.scrollToDate = function(date)
	{
		...
		var offsetWidth = this.chartContainer.width - this.gutterOffset;
	...
	{
		var viewport = this.chartContainer.width - this.gutterOffset;
